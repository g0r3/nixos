...
let
  ...
  downloads = {
    ...
    "5.3.5" = {
      sha256 = "JMs5qgqWfI4HmUWnGJdFiOejS8aCDbZ5wn/prLPhwJg=";
      inherit urls hack;
    }; # released, latest
    "5.3.5-2024-06-13" = {
      inherit hack;
    ...
    "5.2.2" = {
      sha256 = "1bp47179rvs2ahv02f0hna210n886bg7bj8x68qclkk3xj39hici";
      inherit urls hack-pre;
    }; # released
    "5.1.5rc1" = {
      sha256 = "0gdn8rw0r9d4vb0vwy9ylwmbqd6zdaafgjfhx7l3b3ngy1syz56n";
      inherit urls hack-pre;
    };
    "5.1.4" = {
